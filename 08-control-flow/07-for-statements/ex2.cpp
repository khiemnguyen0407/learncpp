...
/* 
Of course, there are ton of points to discuss with for loop. For example, we don't have to 
increment the counter variable one by one. The counter can be incremented by 2 or by a different
number after each iteration. It can also be decremented. 
*/
#include <iostream>
