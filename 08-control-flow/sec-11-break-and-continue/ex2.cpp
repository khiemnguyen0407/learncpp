...
// A break statement terminates the switch or loop, and execution continues at 
// the first statement beyond the switch or loop. A return statement terminates 
// the entire function that the loop is within, and execution continues at 
